...
import com.project.vidmerge.videoTrimmer.HgLVideoTrimmer;
...
public class TrimmerActivity extends AppCompatActivity implements OnTrimVideoListener, OnHgLVideoListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extraIntent != null) {
            path = extraIntent.getStringExtra(HelperClass.EXTRA_VIDEO_PATH);
            maxDuration = extraIntent.getIntExtra(HelperClass.VIDEO_TOTAL_DURATION, 10);
            HelperClass.video_path = path;
        }
...
//            startActivity(intent);
            MainActivity.isVideoTrimmed=true;
            HelperClass.video_path = path;
            finish();
